...
-record(move, {color :: color(), vertex :: vertex()}).

-type simple_entity_type() :: int | float | boolean | color | vertex | move | string.
...
-record(quit, {}).
-record(boardsize, {size :: pos_integer()}).
-record(clear_board, {}).
-record(komi, {new_komi :: float()}).
-record(fixed_handicap, {number_of_stones :: non_neg_integer()}).
-record(place_free_handicap, {number_of_stones :: non_neg_integer()}).
-record(set_free_handicap, {vertices :: [vertex()]}).
-record(play, {move :: #move{}}).
-record(genmove, {color :: color()}).
-record(undo, {}).
...
-record(time_left,
        {color :: color(), time :: non_neg_integer(), stones = 0 :: non_neg_integer()}).
-record(final_score, {}).
-record(final_status_list, {status :: iodata()}).
-record(loadsgf, {filename :: iodata(), move_number :: non_neg_integer() | undefined}).
-record(reg_genmove, {color :: color()}).
-record(showboard, {}).
