-module(gtp_command_place_free_handicap).
...
command_name() -> <<"place_free_handicap">>.

encode_command_arguments(#place_free_handicap{number_of_stones = Stones}) ->
    [gtp_entity:encode(int, Stones)].

decode_command_arguments(Binary) ->
    #place_free_handicap{number_of_stones = gtp_entity:decode_line(int, Binary)}.
